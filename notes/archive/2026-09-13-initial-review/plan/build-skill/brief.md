...
## Problem
The builder has no complete retry contract, mutates state before GitHub preflight, and can commit changes it does not own. See the [framework review](../../../../2026-09-13-review-atlas-framework.md) for the source evidence.
