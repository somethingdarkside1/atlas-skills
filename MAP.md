...
Needs: core-model.
Open questions: Choose the minimum method output; where domain modeling joins interviewing; whether a method has a demonstrated standalone invocation use.
