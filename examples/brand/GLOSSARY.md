...
- Group entries under ### headings when clusters emerge. When the file outgrows a screen, move each cluster to glossary/<cluster>.md and keep this file as the index.
- No diagram: the entries are the glossary, and the map carries the one picture.
-->
