...
Vitali confirmed the full release scope on 2026-09-19 and wants the skills in a good state before his cold run. [0025](../../decisions/0025-finish-simple-skills-before-the-human-run.md) records that order. The [simplicity assessment](../../notes/2026-09-19-research-matt-simplicity.md) informs the work; [skill authoring](../../skills/README.md) owns its writing standard.

Also settled on 2026-09-19: `/build-it` ends with the next review command, and `/review-it` remains separately invoked for this release (Q3). [0026](../../decisions/0026-part-completion-checks-the-combined-outcome.md) requires the combined Outcome check before a part is done (Q4). Remaining work reconciles 0022's accepted light evidence default with 0019, chooses the smallest useful read scope and retry receipt, and resolves the proposed [glossary boundary](../../decisions/0027-glossary-checks-meaning-not-every-word.md). The [remaining-design assessment](../../notes/2026-09-19-review-remaining-design.md) distinguishes that proposal from implementation of existing decisions.
