...
This is the active plan for the first public Atlas revision. Seven work packages own the work, each mapped to a part in [MAP.md](../MAP.md), with one brief and numbered tasks in a flat part folder. The prior 23-task plan is [archived](../notes/archive/2026-09-13-initial-review/README.md), and [MIGRATION.md](MIGRATION.md) accounts for every old task.
...
| [Work skills](work-skills/brief.md) | [01](work-skills/01-interview-and-plan.md) | Implement the eight revised operation contracts |
