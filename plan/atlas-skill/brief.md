...
## Problem
Initialization, status repair, handoff routing, and automatic continuation can contradict the state they read. See the [framework review](../../notes/2026-09-13-review-atlas-framework.md) for the source evidence.
