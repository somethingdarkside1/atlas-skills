...
[0018](../../decisions/0018-one-method-modular-skills.md) sets the product direction: one integrated project method with a full-package default and modular entry points. Describe GitHub source, PRs, and coordination separately from the deferred hosted task adapter; advertise selective installation only for paths supported by the installation evidence.
