...
- The task: status review, boxes ticked, a dated Delivered entry ending with its `Files:` and `Version:` lines. After an early stop: status doing, and a dated entry saying where it stopped.
